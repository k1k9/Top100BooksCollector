...
#
# Title: Collect
# Description: This script grab 100 books from lubimyczytac.pl (top100) and returned this in array
# Author: @k1k9
#
...
def grab100():
	...
	for pageCounter in range(1, 8):
		# Create url addres
		url = 'http://lubimyczytac.pl/ksiazki/popularne/' + str(pageCounter)
